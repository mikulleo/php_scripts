...
//if (isset($_POST['submit'])) {
	...
	$fp = file_put_contents( 'request.log', $json );
...
/*add_action( 'forminator_custom_form_submit_field_data', 'my_callback_function',11,2);
function my_callback_function( $field_data_array, 13 ) {
